...
test("[2] getInterviewersForDay returns an array with a length matching the number of appointments for that day", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(result.length).toEqual(1);
});

test("[3] getInterviewersForDay returns an array containing the correct interview objects", () => {
